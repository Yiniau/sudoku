...
impl GameboardView {
        ...
        where C: CharacterCache<Texture = G::Texture>
    {
        ...
        // Draw cell borders.
        let cell_edge = Line::new(settings.cell_edge_color,
                                        settings.cell_edge_radius);
        for i in 0..9 {
        ...
        let section_edge = Line::new(settings.section_edge_color,
        ...
        // Draw board edge.
        Rectangle::new_border(settings.board_edge_color,
